...
<p align="center">
  <a href="https://devtools.at/tools/json-schema-validator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Validate JSON against schemas</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/json-schema-validator">Try Online</a> •
...
**[Try JSON Schema Validator online at DevTools.at →](https://devtools.at/tools/json-schema-validator)**
...
Validate JSON against schemas. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/json-schema-validator';
